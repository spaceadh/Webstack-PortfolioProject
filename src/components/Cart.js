      ...
      {cart.length > 0 ? (
        <div className="cart__inner">
          ...
          <div className="cart__checkout">
            ...
            <p className="cart__total">Sub-Total: KES {getCartTotal(cart)}</p>
            ...
            <div className="buttons">
                ...
                <a href="https://api.whatsapp.com/send?phone=254787661932&amp;text=Hello, I would like to inquire about ...', '_blank">Order Via WhatsApp</a>
                </button>
        ...
        <div style={{ paddingTop: "1rem" }} className="cart__inner">
          <div className="cart__items">
            <img src={emptyCart} className="cart__empty" alt="empty_cart" />
          </div>
          <div className="cart__checkout">
